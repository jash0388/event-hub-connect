    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-[hsl(221_83%_53%/0.1)]" />
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(212,175,55,0.18) 0%, rgba(184,134,11,0.12) 50%, rgba(212,175,55,0.18) 100%)",
              border: "1.5px solid rgba(212,175,55,0.45)",
              boxShadow: "0 0 15px rgba(212,175,55,0.25), 0 0 40px rgba(212,175,55,0.15), 0 0 80px rgba(212,175,55,0.08), inset 0 0 20px rgba(212,175,55,0.06)",
          ...
          >
            ...
            <span
              ...
              style={{
                background: "linear-gradient(135deg, #D4AF37, #F4E4BC, #D4AF37, #B8860B)",
          ...
          <style>{`
            @keyframes floatGlow {
              0%, 100% {
                ...
                box-shadow: 0 0 15px rgba(212,175,55,0.25), 0 0 40px rgba(212,175,55,0.15), 0 0 80px rgba(212,175,55,0.08), inset 0 0 20px rgba(212,175,55,0.06);
              }
              50% {
                transform: translateY(-8px);
                box-shadow: 0 0 20px rgba(212,175,55,0.4), 0 0 60px rgba(212,175,55,0.25), 0 0 100px rgba(212,175,55,0.12), inset 0 0 25px rgba(212,175,55,0.1);
              }
            }
            @keyframes dotPulse {
              0%, 100% {
              ...
              50% {
                transform: scale(1.3);
                box-shadow: 0 0 12px rgba(212,175,55,1), 0 0 24px rgba(212,175,55,0.6), 0 0 36px rgba(212,175,55,0.3);
              }
            }
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8">
            <span className="text-foreground">Explore, Innovate &</span>
            <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-indigo-600 to-sky-500">Launch Your Career</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed text-balance">
            The ultimate hub for hackathons, career-shifting internships, innovative projects,
            and exclusive networking. Join thousands of students launching their future today.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/learn/codequest">
              <Button
                size="lg"
                className="rounded-full px-8 py-6 text-base bg-foreground text-background hover:bg-foreground/90 group"
              >
                CodeQuest

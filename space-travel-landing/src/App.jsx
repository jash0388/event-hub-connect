...
/* ──────────────────────────────────────────────
   BlurText COMPONENT
────────────────────────────────────────────── */
function BlurText({ text, className = "", el: Tag = "h2", delay = 0 }) {
...
function Navbar() {
    ...
    const links = ["Home", "Events", "Projects", "Learn", "Contact"];
    ...
    return (
        ...
        >
            {/* Logo */}
            <div className="liquid-glass w-12 h-12 rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform duration-300">
                ...
                <div className="hidden md:flex items-center gap-1">
                    {links.map((link) => (
                        <a
                            ...
                            className="font-body text-sm text-white/70 hover:text-white px-4 py-2 rounded-full hover:bg-white/5 transition-all duration-300"
                        >
                            {link}
                        </a>
                    ))}
                </div>
                <a href="http://localhost:3000/login" className="bg-white inline-flex text-[#02040A] font-body font-semibold text-sm px-5 py-2.5 rounded-full items-center gap-2 hover:bg-white/90 transition-all duration-300 hover:scale-105">
                    Join Now
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                ...
                <ScrollReveal delay={0.8}>
                    <div className="flex flex-col sm:flex-row items-center gap-4 mt-10">
                        <a href="http://localhost:3000/events" className="liquid-glass-strong rounded-full px-8 py-4 font-body font-semibold text-white inline-flex items-center gap-3 hover:scale-105 transition-transform duration-300">
                            <Rocket className="w-5 h-5" />
                            Explore Events
                        </a>
                        <a href="http://localhost:3000/projects" className="font-body text-white/70 hover:text-white inline-flex items-center gap-3 px-6 py-4 rounded-full hover:bg-white/5 transition-all duration-300">
                        ...
                        >
                            <div className={`group relative rounded-3xl overflow-hidden cursor-pointer ${dest.span ? "h-[400px] md:col-span-2" : "h-[400px]"}`}>
                                ...
                                <div className="absolute bottom-6 left-6 right-6">
                                    ...
                                    <a href="http://localhost:3000/events" className="liquid-glass rounded-full px-5 py-2.5 font-body text-sm inline-flex text-white/80 hover:text-white items-center gap-2 transition-all duration-300 w-fit">
                    ...
                    <div className="lg:col-span-2">
                        <ScrollReveal>
                            ...
                            <div className="flex gap-2 max-w-md">
                                ...
                                <a href="http://localhost:3000/login" className="bg-white text-[#02040A] font-body font-semibold text-sm px-6 py-3 rounded-full hover:bg-white/90 transition-all duration-300 inline-flex items-center gap-2 hover:scale-105">
